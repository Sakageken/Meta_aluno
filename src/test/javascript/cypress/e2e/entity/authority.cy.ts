...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '1c50bfa1-6a8f-4200-8e8b-80575c46922e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('56cbded8-c79e-4d22-93e3-4c23520603eb');
      cy.get(`[data-cy="name"]`).should('have.value', '56cbded8-c79e-4d22-93e3-4c23520603eb');
